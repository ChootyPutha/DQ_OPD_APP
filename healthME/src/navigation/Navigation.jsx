...
import AppoinmentListScreen from "../screen/Admin/appoinmentList_screen/AppoinmentListSreen";
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator >
                ...
                <Stack.Screen name="PatientHome" options={{ headerShown: true, title: "CareME", headerLeft: () => null, }} component={PatientDashBordScreen} ></Stack.Screen>
                <Stack.Screen name="AdminHome" options={{ headerShown: true, title: "CareME", headerLeft: () => null, }} component={DashBordScreen} ></Stack.Screen>
                <Stack.Screen name="AppoinmetList" options={{ headerShown: true, title: "Appoinment List",  }} component={AppoinmentListScreen} ></Stack.Screen>
